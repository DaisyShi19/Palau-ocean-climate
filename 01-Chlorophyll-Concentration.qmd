...
```{r}
#| echo: false
### Mapping conditions for the report year
FirstYr= paste(RptYr, '-01-01T00:00:00Z', sep = "")
datasetid = 'esa-cci-chla-2022-clim_v6-0'
...
# Read in the files
files <- list.files('Chldata/', full.names = T)
# Read the file into R and combine as stack and sort them after the variable
chl_clim <- brick(files)
...
# Make plot
#log scale
levelplot(chl_clim, pretty=T, margin=F, par.setting=mapTheme, zscaleLog=T)
#regular scale
